...
class SGLangRollout(BaseRollout):
            ...
            request_sampling_params.update(
                {
                    ...
                    "max_new_tokens": getattr(self.config.val_kwargs, "max_tokens", None) or self.config.response_length,
    ...
    async def _handle_engine_generate(
        ...
        # Use max_new_tokens from sampling_params if provided (e.g., from val_kwargs), 
        # otherwise calculate from response_length
