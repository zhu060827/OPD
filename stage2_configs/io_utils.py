        ...
        for line_no, line in enumerate(handle, start=1):
            ...
            records.append(
                CodeRecord(
                    ...
                    prompt=str(data.get("prompt") or data.get("question") or data.get("text") or ""),
...
def _parse_tests(data: Dict) -> List[str]:
    ...
    """
    value = data.get("tests") or data.get("test") or data.get("test_code") or data.get("test_list") or []
    if isinstance(value, list):
